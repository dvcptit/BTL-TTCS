...
<tr>
    ...
    <td >
        <a href="../pages/main/themgiohang.php?cong=<?php echo $cart_item['id'] ?>"><i class="fa-solid fa-plus abc" style="font-size:20px"></i></a>
        <?php echo $cart_item['soluong']?>
        <a href="../pages/main/themgiohang.php?tru=<?php echo $cart_item['id'] ?>"><i class="fa-solid fa-minus abc" style="font-size:20px"></i></a>
    </td>
